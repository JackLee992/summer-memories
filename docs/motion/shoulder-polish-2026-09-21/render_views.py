...
if mode=='baseline':
    bpy.ops.wm.open_mainfile(filepath=str(OUT.parent/'art-weight-trial-2026-09-21/st_hizuru_weight_study.blend'))
...
for f in range(1,61) if mode=='baseline' else range(1,73):

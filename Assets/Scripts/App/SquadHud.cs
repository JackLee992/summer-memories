...
namespace SummerMemories.App
{
    public class SquadHud : MonoBehaviour
    {
        ...
        private Text _waypoint,_weapon;
        ...
        {
            var go=UIFactory.CreatePanel(name,parent,c,Vector2.zero,Vector2.zero,new Vector2(x,1080-y-h),new Vector2(x+w,1080-y));
        ...
        public void Init(SquadDemoDirector app)
        {
            ...
            Label(_play.transform,L("st.hud.brand"),23,44,30,750,40,_gold);
            ...
            Label(footer.transform,L("st.controls"),19,22,13,1790,68);
        ...
        private void LateUpdate()
        {
            ...
            for(var i=0;i<s.Party.Count;i++)
            {
                ...
                _actors[i].text=$"{(i==s.ActiveIndex?"▸":"  ")} {i+1}  {name}   {a.Hp:0}/{a.Config.hp:0}\n     {state}";
                _actors[i].color=i==s.ActiveIndex?_gold:_pale;
        ...
        private void BuildOverlay()
        {
            ...
            if(_screen=="title")
            {
                ...
                Label(box.transform,L("st.title.eyebrow"),23,44,40,700,44,_cyan);
                Label(box.transform,L("st.title.main"),72,40,118,700,105,_pale);
                Label(box.transform,L("st.title.subtitle"),28,44,240,700,105,_gold);
                ...
                Label(box.transform,L("st.title.note"),21,44,595,700,85,_pale);return;
            }
